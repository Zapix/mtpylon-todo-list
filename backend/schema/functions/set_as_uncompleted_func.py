...
from todos.utils import get_task_for_user, mark_uncompleted
...
@login_required
async def set_as_uncompleted(request: Request, task_id: int) -> Task:
    ...
    updated_task = await mark_uncompleted(task)
